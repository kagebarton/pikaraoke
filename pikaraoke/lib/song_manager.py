...
class SongManager:
    ...
    def _get_companion_files(self, song_path: str) -> list[str]:
        """Return paths to companion files (.srt, vocal/nonvocal, .ass) that exist alongside a song.
        ...
        Karaoke captions (.ass, generated by lyric_align) are expected in 'karaoke/' subfolder.
        """
        ...
        # Karaoke caption (.ass) from lyric_align
        ass_path = os.path.join(dirpath, "karaoke", base + ".ass")
    ...
    def get_pipeline_state(self, song_path: str) -> str | None:
        """Forwarder for pipeline_state reads."""
